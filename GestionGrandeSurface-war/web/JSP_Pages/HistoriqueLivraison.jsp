      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Vos Livraisons<small></small></h2>
                   ...
                   <form method="post" action="ControleAdministration">
                      ...
                      <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="datatable-checkbox" rowspan="1" colspan="1" aria-label="Date de livraison : activer pour ordonner" style="width: 126px;">Date de livraison</th>
                            <th class="sorting" tabindex="0" aria-controls="datatable-checkbox" rowspan="1" colspan="1" aria-label="Date de livraison : activer pour ordonner" style="width: 126px;">Date de livraison prévu</th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="datatable-checkbox" rowspan="1" colspan="1" aria-label="Etat de livraison : activer pour ordonner" style="width: 126px;">Etat de livraison</th>
                            <th class="sorting" tabindex="0" aria-controls="datatable-checkbox" rowspan="1" colspan="1" aria-label="Référence du Bon de commande : activer pour ordonner" style="width: 126px;">Référence du Bon de commande</th>
                            <th class="sorting" tabindex="0" aria-controls="datatable-checkbox" rowspan="1" colspan="1" aria-label="Montant de livraison : activer pour ordonner" style="width: 126px;">Montant de livraison</th>
                        </tr>
                      </thead>
                      <tbody>
                      
                         <% 
                        List<Livraison> livr = listLivraisons;
                        for( Livraison l : livr) {
                        float montantLivraison= 0.0f;
                        %>
                          <tr role="row" class="odd">
                          <td style="display : none"></td>
                          <td><%=new SimpleDateFormat("dd-MM-yyyy").format(l.getDate_livraison())%></td>
                          <td><%=new SimpleDateFormat("dd-MM-yyyy").format(l.getDate_livraison_prevu())%></td>
                          ...
                          <% 
                          for (LigneCommande lc : l.getBonCommande().getLigneCommandes())
                          {
                             montantLivraison+=(lc.getPrix_achat()*lc.getQuantite());
                          }
                           %>
                          <td><%=montantLivraison%> €</td>
                         </tr>
                        <%;}%>
