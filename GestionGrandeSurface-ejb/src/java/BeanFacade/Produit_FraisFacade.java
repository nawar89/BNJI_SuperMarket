...
public class Produit_FraisFacade extends AbstractFacade<Produit_Frais> implements Produit_FraisFacadeLocal {
    ...
    //Creation article
    @Override
    public void creerProduitFrais(String libelle, String reference, float prix_achat_actuel, Date date_de_creation, String description, SousCategorie sous_categorie, Fournisseur fournisseur,String img) throws Exception {
        try {
